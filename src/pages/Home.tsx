...
export default function Home() {
  return (
    <div>
      ...
      <div className="bg-gradient-to-r from-blue-500 to-purple-600 rounded-xl p-6 sm:p-8 text-white shadow-2xl">
        ...
        <Link
          to="/parsing"
          className="inline-block bg-white text-purple-600 px-5 sm:px-6 py-2.5 sm:py-3 rounded-lg text-sm sm:text-base font-semibold hover:bg-gray-100 transition-colors"
        >
          Start Learning →
        </Link>
      </div>
